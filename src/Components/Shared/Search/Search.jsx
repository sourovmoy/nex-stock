...
const Search = () => {
  ...
  return (
    <div>
      ...
      >
        <div className={`fixed inset-0 z-50 w-screen overflow-y-auto sm:pr-90`}>
          <div className="flex min-w-full justify-center md:justify-end">
            <DialogPanel
              transition
              className="w-full sm:w-2/3 md:w-full max-w-sm rounded-sm bg-gray-200 duration-300 ease-out data-closed:transform-[scale(95%)] data-closed:opacity-0 h-10 mt-15 sm:mt-2"
            >
