...
export default function CategoryProductsSkeleton() {
  return (
    <>
      <h1 className="h-6 w-60 bg-black/8 rounded my-3 animate-pulse"></h1>
      <div className="bg-white border border-black/10 rounded-xl overflow-hidden shadow-sm">
        {/* Skeleton Header */}
        <div className="bg-black/5 px-4 py-3 grid grid-cols-7 gap-4 text-sm font-medium text-black/60">
          <div>#</div>
          <div>Name</div>
          <div>SKU</div>
          <div>Cost Price</div>
